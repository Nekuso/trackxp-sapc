            ...
            {allowedLinks.map((link, i) => {
              ...
              return (
                <div
                  ...
                  className={`group relative w-auto flex place-items-center justify-start cursor-pointer bg-${
            ...
            {systemLinks.map((link, i) => {
              ...
              return (
                <div
                  ...
                  className="group cursor-pointer relative w-auto flex place-items-center justify-start bg-transparent hover:bg-applicationPrimary text-sm font-medium p-4 rounded-xl primary-glow transition-all duration-300 gap-4 hover:scale-110"
                  key={`b_${i}`}
                >
                  <Image
                    src={icon}
