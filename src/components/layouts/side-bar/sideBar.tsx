      ...
      <div className="w-auto h-full flex flex-col justify-between">
        ...
        <div className="w-full flex flex-col gap-2">
          ...
          <div
            ...
            className="cursor-pointer group relative w-auto flex place-items-center justify-start bg-transparent hover:bg-applicationPrimary text-sm font-medium p-4 rounded-full hover:shadow-sm hover:shadow-applicationPrimary transition-all gap-4"
          >
            <Image src={logoutIcon} alt="trackxp icon" className="w-6" />
            <span className="invisible group-hover:visible opacity-0 duration-500 group-hover:opacity-100 absolute left-full group-hover:left-[150%] transition-all text-sm bg-applicationPrimary rounded-lg px-4 py-2 z-50">
              Signout
            </span>
          </div>
